...
def agno_worker_main(recv_queue, send_queue, name: str,
    ...
    # ── D-SPEC-137 (v1.62.3, 2026-05-26) — Eager OVG warmup ──
    # OutputVerifier construction (Solana keypair load + TimeChain.open) is
    # ~30s cold-start on T1 (50 MB mainnet chain). Pre-D-SPEC-137 the OVG
    ...
    if worker_plugin is not None:
        try:
            ...
            logger.info(
                ...
                "D-SPEC-137; closes first-chat cold-start cascade)",
