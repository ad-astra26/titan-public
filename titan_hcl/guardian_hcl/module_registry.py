"""
titan_hcl.guardian_hcl.module_registry — dataclasses + supervision-log helper.

Carved from titan_hcl/guardian.py by scripts/_phase6_carve_guardian.py per
SPEC §11.B.4 / D-SPEC-135 / v1.62.0. Dataclasses + free functions only —
no Guardian class behaviour here. Imports preserved verbatim from the
source so the dataclasses' field defaults / annotations resolve identically.
"""
"""
