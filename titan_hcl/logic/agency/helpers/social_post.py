...
class SocialPostHelper:
    ...
    (titan_hcl/logic/social_x_gateway.py). This helper is no longer
    registered in production paths (TitanHCL._register_helpers and
    ...
    def __init__(self, api_key: str = "", proxy: Optional[str] = None,
        ...
        if not _explicit_opt_in:
            raise ValueError(
                ...
                "must go through titan_hcl.logic.social_x_gateway.SocialXGateway. "
