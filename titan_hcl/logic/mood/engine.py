...
class MoodRegistry:
    ...
    """
    def __init__(self, addons_dir: str = "titan_hcl/addons"):
    ...
    def hot_load(self, active_module_names: List[str]):
        ...
        for module_name in active_module_names:
            try:
                # The addons are expected to be in titan_hcl/addons/
                # We import it via the package structure: titan_hcl.addons.module_name
                module_path = f"titan_hcl.addons.{module_name}"
...
class MoodEngine:
    ...
    """
    def __init__(self, metabolism_client, config_path: str = "titan_hcl/config.toml"):
