"""
titan_hcl/logic/perception/ — SensoryHub: Extensible Multi-Modal Perception Framework.
...
Usage in spirit_worker:
    from titan_hcl.logic.perception import SensoryHub
    hub = SensoryHub()
    hub.auto_discover()
...
class SensoryHub:
    ...
    def auto_discover(self) -> int:
        ...
        for fname in sorted(os.listdir(perception_dir)):
            ...
            try:
                mod = importlib.import_module(f"titan_hcl.logic.perception.{module_name}")
