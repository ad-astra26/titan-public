...
from titan_hcl._phase_c_constants import SCHUMANN_SPIRIT_HZ
...
MAX_PAYLOAD_BYTES: int = 16384  # Sprint 7 §4.6 raw-inputs schema (was 4096 for legacy {tensor:[45D]} payload); now carries consciousness + hormone_levels + hormone_fires + unified_spirit_stats + sphere_clocks + memory_stats + topology + expression_stats + composites + birth_state → ~5-6KB typical
        ...
        while not stop_event.is_set():
            ...
            if sleep_for > 0:
                ...
                if (self._drift_recovery_last_warn_ts == 0.0
                    ...
                    if self._drift_recovery_last_warn_ts == 0.0:
                        logger.warning(
                            "inner_spirit_sensor_refresh drift recovery: "
