...
# Phase 11 §11.I.7 / §11.I.8 (Chunk 11F) — orchestrator state SHM contract
# + BootPriority enum. Re-exported here for orchestrator consumers
# (kernel-rs reader, observatory readiness route, tests).
from titan_hcl.core.module_state import BootPriority
