"""
titan_hcl/core/kernel_interface.py — KernelView typed Protocol.
...
See:
  ...
  - titan_hcl/core/kernel.py (concrete impl that satisfies this shape)
  - titan_hcl/core/plugin.py (primary consumer via self.kernel)
"""
