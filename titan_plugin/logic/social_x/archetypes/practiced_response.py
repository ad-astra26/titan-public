...
class PracticedResponseArchetype(ArchetypeBase):
    ...
    def _pool_b(self, *, now: float) -> dict | None:
        ...
        for r in rows:
            ...
            return {
                "source_id": sid,
                "salience": float(r["confidence"] or 0.0),
                "relevance": float(r["terminal_reward"] or 0.0),
                "triggering_program": r["triggering_program"] or "",
                "posture": r["posture"] or "",
                "terminal_reward": float(r["terminal_reward"] or 0.0),
