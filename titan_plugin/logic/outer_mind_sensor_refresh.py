...
Failure semantics / Flag-gating sections. This module differs only in:
  ...
  - REFRESH_PERIOD_S = OUTER_MIND_TICK_BASE_S (5.0 s) — fastest natural
    cadence per SPEC §9.D line 1030 ("outer_mind: persona narrative
    ~10s, social context ~5s")
...
REFRESH_PERIOD_S: float = OUTER_MIND_TICK_BASE_S  # 5.0
