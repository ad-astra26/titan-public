#!/usr/bin/env python3
"""Live runtime E2E verification for P0-P7 of the synthesis engine.

Per `PLAN_synthesis_engine_Phase7.md §P7.K` (Maker-requested 2026-05-27).
Extends the P0-P6 25-check baseline with Phase 7 working-memory buffer
checks (K1-K8). HTTP-only — no SSH, no direct DB / SHM access.
