...
async def resurrect_from_chain(
    *,
    ...
    # The on-chain typ=B|I lets us anchor at the LATEST baseline (a full re-ship)
    # and apply forward — canonical + minimal, no pre-baseline history needed.
    ...
    log(f"Anchoring at latest baseline {start_baseline['event_id'][:8]} "
