#!/usr/bin/env python3
"""Live runtime E2E verification for P0-P6 of the synthesis engine.

Per `PLAN_synthesis_engine_Phase6.md §P6.M` (Maker-requested 2026-05-27).
Extends the P5 18-check baseline with Phase 6 oracle + proof middleware
checks. HTTP-only — no SSH, no direct DB / SHM access.
