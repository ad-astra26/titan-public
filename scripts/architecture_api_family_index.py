...
Output: titan-docs/ARCHITECTURE_api_family_index.md (overwrites; never hand-edit).
...
ARCH_PATH = REPO_ROOT / "titan-docs" / "ARCHITECTURE_api_family.md"
INDEX_PATH = REPO_ROOT / "titan-docs" / "ARCHITECTURE_api_family_index.md"
...
def render(parsed: dict) -> str:
    ...
    out.append("")
    out.append(
        "> **Auto-generated** from `titan-docs/ARCHITECTURE_api_family.md` by "
