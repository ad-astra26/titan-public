#!/usr/bin/env python3
"""Live runtime E2E verification for P0-P8 of the synthesis engine.

Per `PLAN_synthesis_engine_Phase8.md §P8.L` (Maker-requested 2026-05-27).
Extends the P0-P7 30-check baseline with Phase 8 procedural skill miner
checks (L1-L11) for 41 total. HTTP-only — no SSH, no direct DB / SHM access.
...
Usage:
    python scripts/synthesis_p0_p7_live_runtime_e2e.py --target=T1
    python scripts/synthesis_p0_p7_live_runtime_e2e.py --target=T2
    python scripts/synthesis_p0_p7_live_runtime_e2e.py --target=T3
    python scripts/synthesis_p0_p7_live_runtime_e2e.py --target=all
